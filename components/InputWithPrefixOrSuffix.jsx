...
export default function InputWithPrefixOrSuffix(props) {
	...
	const Extension = (props) => {
		...
		return (
			<Card sizing={"border"} padding={2} radius={2} tone={!isFetching && !hasError ? "transparent" : "critical"} style={{ display: "flex", alignItems: "center", maxWidth: "25%", minHeight: "2.1875rem" }}>
				{isFetching
					? <Spinner muted />
					: ""
				}
